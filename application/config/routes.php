...
$route['viewEmployee2'] = 'employee/viewEmployee2';
$route['viewTest'] = 'employee/viewTest';
$route['logout'] = 'employee/logout';
$route['dataEmployee'] = 'employee/dataEmployee';
$route['dataEmployee2'] = 'employee/dataEmployee2';
$route['addEmployee'] = 'employee/addEmployee';
$route['editEmployee'] = 'employee/editEmployee';
$route['toEditEmployee'] = 'employee/toEditEmployee';
