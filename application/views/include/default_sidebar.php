      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li>
                      <a class="active" href="viewEmployee">
                          <i class="fa fa-user"></i>
                          <span>Employee</span>
                      </a>
                  </li>
                  <li>
                      <a class="active" href="viewEmployee2">
                          <i class="fa fa-user"></i>
                          <span>EmployeeDataTableSample</span>
                      </a>
                  </li>
                  <li>
                      <a class="active" href="viewTest">
                          <i class="fa fa-file"></i>
                          <span>DYNAMIC TABLE TEST</span>
                      </a>
                  </li>
<!--                   <li class="sub-menu">
                      <a href="javascript:;" >
